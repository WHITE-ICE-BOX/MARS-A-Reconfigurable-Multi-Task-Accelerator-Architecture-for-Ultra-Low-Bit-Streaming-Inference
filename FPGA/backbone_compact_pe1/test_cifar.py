...
ol = FINNExampleOverlay(
    bitfile_name="/home/xilinx/pe1_backbone/resizer.bit",
    platform="zynq-iodma",
    io_shape_dict=io_shape_dict,
    batch_size=1,
    runtime_weight_dir="/home/xilinx/pe1_backbone/runtime_weights/")
...
for i in range(N):
    ...
    if int(out[0][0]) == int(y_all[i]):
        correct += 1
print(f'CIFAR-10 PE=1 backbone: acc = {correct}/{N} = {100*correct/N:.2f}%, FPS = {N/(time.time()-t0):.1f}')
