...
BASE_OUTPUT_DIR = os.path.join(CLAUDE_DIR, "paper_results_cinic10")
...
# ==========================================
def parse_args():
    parser = argparse.ArgumentParser(description="Automated Experiment: CIFAR10 -> CINIC10")
    ...
    parser.add_argument("--target", type=str, default="CINIC10")
