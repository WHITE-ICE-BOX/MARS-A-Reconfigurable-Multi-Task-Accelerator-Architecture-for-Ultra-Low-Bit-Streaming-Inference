...
BASE_OUTPUT_DIR = os.path.join(CLAUDE_DIR, "paper_results_fashionmnist")
...
# ==========================================
def parse_args():
    parser = argparse.ArgumentParser(description="Automated Experiment: CIFAR10 -> FashionMNIST")
    ...
    parser.add_argument("--target", type=str, default="FashionMNIST")
